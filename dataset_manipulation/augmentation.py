...
def random_perspective(img, factor=0.5):
    return RandomPerspective(factor, p=1, fill=255)(img)
...
def main():
    img_path = '/home/hiof_bachelor/tobias/PHOSCnet/image_data/user010-sample001.jpg'

    img = Image.open(img_path)

    # img_shear = shear_x(img, 1) # [1, -1]
    img_shear = shear_y(img, 0.01) # [-0.05, 0.05]
